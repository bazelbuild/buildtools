...
func (Dependency_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_548674b5b5a8131d, []int{1, 0}
}
...
func (*SourceLocation) Descriptor() ([]byte, []int) {
	return fileDescriptor_548674b5b5a8131d, []int{0}
}
...
func (*Dependency) Descriptor() ([]byte, []int) {
	return fileDescriptor_548674b5b5a8131d, []int{1}
}
...
func (*Dependencies) Descriptor() ([]byte, []int) {
	return fileDescriptor_548674b5b5a8131d, []int{2}
}
...
func init() { proto.RegisterFile("deps_proto/deps.proto", fileDescriptor_548674b5b5a8131d) }

var fileDescriptor_548674b5b5a8131d = []byte{
