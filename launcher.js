...
function getNativeBinary() {
  ...
  // There has not a release for darwin-arm64 yet. Fall back to using x86_64
  // binary for darwin-arm64 instead of failing it.
  if (arch == 'arm64' && platform == 'darwin') {
    return path.join(__dirname, `_TOOL_-darwin_x86_64`);
  }
