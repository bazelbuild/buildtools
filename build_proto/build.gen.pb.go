...
func (Target_Discriminator) EnumDescriptor() ([]byte, []int) {
	return file_build_proto_build_proto_rawDescGZIP(), []int{15, 0}
}
...
func (AllowedRuleClassInfo_AllowedRuleClasses) EnumDescriptor() ([]byte, []int) {
	return file_build_proto_build_proto_rawDescGZIP(), []int{17, 0}
}
...
func (*AttributeValue_DictEntry) Descriptor() ([]byte, []int) {
	return file_build_proto_build_proto_rawDescGZIP(), []int{19, 0}
}
...
var file_build_proto_build_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_build_proto_build_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
var file_build_proto_build_proto_goTypes = []any{
